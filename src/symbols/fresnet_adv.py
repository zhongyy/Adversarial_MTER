...
def residual_unit_v1(data, num_filter, stride, dim_match, name, bottle_neck, **kwargs):
    ...
    if bottle_neck:
        ...
        bn1 = mx.sym.BatchNorm(data=conv1, fix_gamma=False,use_global_stats=True,output_mean_var=False, eps=2e-5, momentum=bn_mom, name=name + '_bn1')
        ...
        bn2 = mx.sym.BatchNorm(data=conv2, fix_gamma=False,use_global_stats=True,output_mean_var=False, eps=2e-5, momentum=bn_mom, name=name + '_bn2')
        ...
        bn3 = mx.sym.BatchNorm(data=conv3, fix_gamma=False,use_global_stats=True,output_mean_var=False, eps=2e-5, momentum=bn_mom, name=name + '_bn3')
        ...
        if dim_match:
            ...
            shortcut = mx.sym.BatchNorm(data=conv1sc, fix_gamma=False,use_global_stats=True,output_mean_var=False, eps=2e-5, momentum=bn_mom, name=name + '_sc')
        if memonger:
        ...
        conv1 = Conv(data=data, num_filter=num_filter, kernel=(3, 3), stride=stride, pad=(1, 1),
                     no_bias=True, workspace=workspace, name=name + '_conv1')
        bn1 = mx.sym.BatchNorm(data=conv1, fix_gamma=False,use_global_stats=True,output_mean_var=False, momentum=bn_mom, eps=2e-5, name=name + '_bn1')
        act1 = Act(data=bn1, act_type=act_type, name=name + '_relu1')
        conv2 = Conv(data=act1, num_filter=num_filter, kernel=(3, 3), stride=(1, 1), pad=(1, 1),
                     no_bias=True, workspace=workspace, name=name + '_conv2')
        bn2 = mx.sym.BatchNorm(data=conv2, fix_gamma=False,use_global_stats=True,output_mean_var=False, momentum=bn_mom, eps=2e-5, name=name + '_bn2')
        if use_se:
            # se begin
        ...
        if dim_match:
            ...
            conv1sc = Conv(data=data, num_filter=num_filter, kernel=(1, 1), stride=stride, no_bias=True,
                           workspace=workspace, name=name + '_conv1sc')
            shortcut = mx.sym.BatchNorm(data=conv1sc, fix_gamma=False,use_global_stats=True,output_mean_var=False, momentum=bn_mom, eps=2e-5, name=name + '_sc')
        if memonger:
            shortcut._set_attr(mirror_stage='True')
...
def residual_unit_v2(data, num_filter, stride, dim_match, name, bottle_neck, **kwargs):
    ...
    if bottle_neck:
        ...
        bn1 = mx.sym.BatchNorm(data=data, fix_gamma=False,use_global_stats=True,output_mean_var=False, eps=2e-5, momentum=bn_mom, name=name + '_bn1')
        act1 = Act(data=bn1, act_type=act_type, name=name + '_relu1')
        conv1 = Conv(data=act1, num_filter=int(num_filter * 0.25), kernel=(1, 1), stride=(1, 1), pad=(0, 0),
                     no_bias=True, workspace=workspace, name=name + '_conv1')
        bn2 = mx.sym.BatchNorm(data=conv1, fix_gamma=False,use_global_stats=True,output_mean_var=False, eps=2e-5, momentum=bn_mom, name=name + '_bn2')
        act2 = Act(data=bn2, act_type=act_type, name=name + '_relu2')
        conv2 = Conv(data=act2, num_filter=int(num_filter * 0.25), kernel=(3, 3), stride=stride, pad=(1, 1),
                     no_bias=True, workspace=workspace, name=name + '_conv2')
        bn3 = mx.sym.BatchNorm(data=conv2, fix_gamma=False,use_global_stats=True,output_mean_var=False, eps=2e-5, momentum=bn_mom, name=name + '_bn3')
        ...
        bn1 = mx.sym.BatchNorm(data=data, fix_gamma=False,use_global_stats=True,output_mean_var=False, momentum=bn_mom, eps=2e-5, name=name + '_bn1')
        act1 = Act(data=bn1, act_type=act_type, name=name + '_relu1')
        conv1 = Conv(data=act1, num_filter=num_filter, kernel=(3, 3), stride=stride, pad=(1, 1),
                     no_bias=True, workspace=workspace, name=name + '_conv1')
        bn2 = mx.sym.BatchNorm(data=conv1, fix_gamma=False,use_global_stats=True,output_mean_var=False, momentum=bn_mom, eps=2e-5, name=name + '_bn2')
        act2 = Act(data=bn2, act_type=act_type, name=name + '_relu2')
...
def residual_unit_v3(data, num_filter, stride, dim_match, name, bottle_neck, **kwargs):
    ...
    if bottle_neck:
        ...
        conv3 = Conv(data=act2, num_filter=num_filter, kernel=(1, 1), stride=stride, pad=(0, 0), no_bias=True,
                     workspace=workspace, name=name + '_conv3')
        bn4 = mx.sym.BatchNorm(data=conv3, fix_gamma=False,use_global_stats=True,output_mean_var=False, eps=2e-5, momentum=bn_mom, name=name + '_bn4')
...
def resnet(units, num_stages, filter_list, num_classes, bottle_neck, **kwargs):
    ...
    data = data - 127.5
    data = data * 0.0078125
    # data = mx.sym.BatchNorm(data=data, fix_gamma=False,use_global_stats=True,output_mean_var=False, eps=2e-5, momentum=bn_mom, name='bn_data')
    if version_input == 0:
        body = Conv(data=data, num_filter=filter_list[0], kernel=(7, 7), stride=(2, 2), pad=(3, 3),
                    no_bias=True, name="conv0", workspace=workspace)
        body = mx.sym.BatchNorm(data=body, fix_gamma=False,use_global_stats=True,output_mean_var=False, eps=2e-5, momentum=bn_mom, name='bn0')
    ...
    body = mx.sym.BatchNorm(data=body, fix_gamma=False,use_global_stats=True,output_mean_var=False, eps=2e-5, momentum=bn_mom, name='bn1')
    body = mx.symbol.Dropout(data=body, p=0)
    fc1 = mx.sym.FullyConnected(data=body, num_hidden=num_classes, name='pre_fc1')
    fc1 = mx.sym.BatchNorm(data=fc1, fix_gamma=True,use_global_stats=True,output_mean_var=False, eps=2e-5, momentum=bn_mom, name='fc1')
    return fc1
